 ...
 */
#ifndef X86_RECORD_METRIC_PLUGIN_WRAPPER_HPP
#define X86_RECORD_METRIC_PLUGIN_WRAPPER_HPP
...
namespace metric_plugin_wrapper
{
    enum class Mode
    {
        ACCUMULATED_START = 0,
...
#endif // X86_RECORD_METRIC_PLUGIN_WRAPPER_HPP
