...
constexpr pid_t otf2_trace::METRIC_PID;
...
otf2_trace::otf2_trace(uint64_t sample_period, const std::string& trace_path)
...
void otf2_trace::begin_record()
{
    log::info() << "Initialization done. Start recording...";
    starting_time_ = get_time();
}

void otf2_trace::end_record()
{
    stopping_time_ = get_time();
    log::info() << "Recording done. Start finalization...";
}

otf2::chrono::time_point otf2_trace::record_from() const
{
    return starting_time_;
}

otf2::chrono::time_point otf2_trace::record_to() const
{
...
std::map<std::string, otf2::definition::regions_group> otf2_trace::function_groups()
{
...
void otf2_trace::process(pid_t pid, const std::string& name)
{
...
otf2::writer::local& otf2_trace::sample_writer(pid_t pid, pid_t tid)
{
...
otf2::writer::local& otf2_trace::metric_writer(pid_t pid, pid_t tid)
{
...
otf2::writer::local& otf2_trace::metric_writer(const std::string& name)
{
    auto location =
...
otf2::definition::metric_member otf2_trace::metric_member(const std::string& name,
...
otf2_trace::metric_instance(otf2::definition::metric_class metric_class,
...
otf2::definition::metric_class otf2_trace::metric_class()
{
    auto ref = metric_instances_.size() + metric_classes_.size();
...
void otf2_trace::merge_ips(ip_ref_map& new_children, ip_cctx_map& children,
...
otf2::definition::mapping_table otf2_trace::merge_ips(ip_ref_map& new_ips, uint64_t ip_count,
...
otf2::definition::source_code_location otf2_trace::intern_scl(const line_info& info)
{
...
otf2::definition::region otf2_trace::intern_region(const line_info& info)
{
...
otf2::definition::string otf2_trace::intern(const std::string& name)
{
