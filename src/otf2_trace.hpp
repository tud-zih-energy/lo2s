 ...
 */
#ifndef X86_RECORD_OTF2_TRACE_HPP
#define X86_RECORD_OTF2_TRACE_HPP
...
public:
    ...
    otf2_trace(uint64_t sample_period, const std::string& trace_path);
...
#endif // X86_RECORD_OTF2_TRACE_HPP
